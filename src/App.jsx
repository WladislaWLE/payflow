...
const SVC = [
  ...
  {id:5,  name:"Gemini Advanced",       slug:"gemini-advanced",    cat:"AI",            icon:"💎", tiers:[{n:"Google One",p:19.99}],                              login:true, gift:true, family:true, newAcc:false, desc:"Gemini Advanced с доступом к Gemini 2.5 Pro от Google. Deep Research, анализ видео и документов, интеграция с Gmail, Docs, Drive и Workspace. Входит в Google One AI Premium с 2TB хранилища."},
  {id:6,  name:"Midjourney",            slug:"midjourney",         cat:"AI",            icon:"🎨", tiers:[{n:"Basic",p:10},{n:"Standard",p:30},{n:"Pro",p:60},{n:"Mega",p:120}],login:true,gift:false,family:false,newAcc:true, desc:"Лидер AI-генерации изображений. Создаёт фотореалистичные и художественные изображения с тонким контролем стиля, освещения и композиции. Незаменим для дизайнеров, маркетологов и художников. Оплата Midjourney в России через Payflow."},
  ...
  {id:11, name:"Cursor Pro",            slug:"cursor-pro",         cat:"Разработка",    icon:"💻", tiers:[{n:"Pro",p:20},{n:"Ultra",p:200}],                       login:true,gift:false,family:false,newAcc:true, desc:"Cursor Pro — лучший AI-редактор кода в 2026 году. Доступ к Claude Sonnet 4, GPT-4o и o3. Агентный режим сам пишет, запускает и фиксит код. Ultra — для интенсивной разработки без лимитов."},
  {id:12, name:"GitHub Copilot",        slug:"github-copilot",     cat:"Разработка",    icon:"⚡", tiers:[{n:"Pro",p:10},{n:"Pro+",p:39}],                         login:true,gift:false,family:false,newAcc:false,desc:"GitHub Copilot — AI-ассистент от Microsoft прямо в IDE: выбор между Claude, GPT-4o и Gemini. Автодополнение, чат, code review, агентный режим и Copilot Workspace для планирования задач."},
